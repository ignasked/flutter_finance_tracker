...
class _AddTransactionScreen extends State<AddTransactionScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => TransactionFormCubit(transaction: transaction),
      ...
      appBar: AppBar(
        title: BlocBuilder<TransactionFormCubit, TransactionFormState>(
          builder: (context, state) => Text(
            state.initialTransaction == null ? 'Add Transaction' : 'Edit Transaction',
          ),
        ),
      ),
      body: Padding(
          ...
          builder: (context, state) {
            return Column(
              children: [
                ...
                const SizedBox(height: 20),
                ElevatedButton(
                  onPressed: () => context.read<TransactionFormCubit>().submitForm(),
