      ...
      appBar: AppBar(
        title: BlocBuilder<TransactionFormCubit, TransactionFormState>(
          builder: (context, state) => Text(
            state.formType == TransactionFormType.addNew ? 'Add Transaction' : 'Edit Transaction',
          ),
        ),
      ),
      body: Padding(
          ...
          builder: (context, state) {
            return Column(
              children: [
                ...
                TextFormField(
                  onChanged: (value) => context.read<TransactionFormCubit>().amountChanged(value),
                  decoration: InputDecoration(labelText: 'Amount', border: OutlineInputBorder(), errorText: state.amount.isNotValid ? 'Amount cannot be empty' : null),
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: ['Income', 'Expense']
                      ...
                      .toList(),
                  onChanged: (value) => context.read<TransactionFormCubit>().typeChanged(value!),
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: _categories
                      ...
                      .toList(),
                  onChanged: (value) => context.read<TransactionFormCubit>().categoryChanged(value!),
                  decoration: const InputDecoration(labelText: 'Category', border: OutlineInputBorder()),
                ),
                const SizedBox(height: 20),
                ElevatedButton(
                  onPressed: state.isValid == true ?  () => context.read<TransactionFormCubit>().submitForm(context) : null,
